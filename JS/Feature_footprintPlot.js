/**
 * Feature_footprintPlot.js
 *
 *
 * Transforms the radius of the visible Earth footprint for a space object from a radius and latitude centre to a lat/lon circle.
 * 
 ...
 * 
 * Include package in html using: <script src="feature_footprintPlot.js"></script>
 * 
 * Inputs:
 *        latitude  - The latitude of the object.
 *        longitude - The longitude of the object.
 *        radius    - The radius of the visible earth footprint. 
 *
 * Outputs:
 *        Outputs an array of latitude and longitude coordinates.
*/
